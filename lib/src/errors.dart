...
class HTErr_ArgType extends HT_Error {
  HTErr_ArgType(String id, String assign_value, String declValue, [String fileName, int line, int column])
      : super(
          '${HT_Lexicon.errorArgType1} "$assign_value" ${HT_Lexicon.errorOfType} "$assign_value" ${HT_Lexicon.errorArgType2} "$declValue"',
          fileName,
          line,
          column,
        );
...
class HTErr_ReturnType extends HT_Error {
  HTErr_ReturnType(String returnedType, String funcName, String declReturnType, [String fileName, int line, int column])
      : super(
