...
class HTInterpreter {
  ...
  void _handleWhen() {
    ...
    for (var i = 0; i < casesCount; ++i) {
      ...
      if (caseType == HTWhenCaseTypeCode.equals) {
        final value = execute();
        if (hasCondition) {
          if (condition == value) {
            break;
      ...
      } else if (caseType == HTWhenCaseTypeCode.eigherEquals) {
        assert(hasCondition);
      ...
      } else if (caseType == HTWhenCaseTypeCode.elementIn) {
        assert(hasCondition);
