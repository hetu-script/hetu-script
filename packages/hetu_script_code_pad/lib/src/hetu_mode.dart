...
final hetuscript = Mode(refs: {
  ...
  '~contains~3~starts~contains~1':
    ...
    "built_in":
        "object function bool num int string List Map prototype Math Future print stringify jsonify toJson toString keys values containsKey contains length fromJson clone"
  }, contains: [
