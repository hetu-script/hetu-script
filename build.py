...
os.system('dart run packages/hetu_script_dev_tools/bin/cli_tool.dart compile lib/core/main.ht packages/hetu_script/lib/precompiled_module.dart -a "hetuCoreModule"')
