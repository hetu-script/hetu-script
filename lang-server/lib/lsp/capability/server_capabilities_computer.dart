...
// import '../semantic_tokens/legend.dart';
...
class ClientDynamicRegistrations {
  /// All dynamic registrations supported by the LSP server.
  ///
...
class ServerCapabilitiesComputer {
  ...
  ServerCapabilities computeServerCapabilities(
    ...
    return ServerCapabilities(
      ...
      //             firstTriggerCharacter: typeFormattingCharacters.first,
      //             moreTriggerCharacter:
      //                 typeFormattingCharacters.skip(1).toList())
      //         : null,
  ...
  Future<void> performDynamicRegistration() async {
    final hetuFiles = DocumentFilter(language: 'hetu', scheme: 'file');
    final fullySupportedTypes = [hetuFiles];
    ...
    //     documentSelector: [hetuFiles], // This one is currently Dart-specific
    //     firstTriggerCharacter: typeFormattingCharacters.first,
    //     moreTriggerCharacter: typeFormattingCharacters.skip(1).toList(),
    //   ),
    // );
    // register(
